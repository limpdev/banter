...
## Parsing and Creating Templates[​](#parsing-and-creating-templates "Direct link to Parsing and Creating Templates")

#### Naming Templates[​](#naming-templates "Direct link to Naming Templates")
...
#### Parsing Multiple Templates[​](#parsing-multiple-templates "Direct link to Parsing Multiple Templates")
...
## Executing Templates[​](#executing-templates "Direct link to Executing Templates")

#### Execute a Single Template[​](#execute-a-single-template "Direct link to Execute a Single Template")
...
#### Executing a Named Template[​](#executing-a-named-template "Direct link to Executing a Named Template")
...
## Template Encoding and HTML[​](#template-encoding-and-html "Direct link to Template Encoding and HTML")

#### Contextual Encoding[​](#contextual-encoding "Direct link to Contextual Encoding")
...
#### Safe Strings and HTML Comments[​](#safe-strings-and-html-comments "Direct link to Safe Strings and HTML Comments")
...
#### The dot character (.)[​](#the-dot-character- "Direct link to The dot character (.)")
...
#### Variables in Templates[​](#variables-in-templates "Direct link to Variables in Templates")
...
## Template Actions[​](#template-actions "Direct link to Template Actions")

#### If/Else Statements[​](#ifelse-statements "Direct link to If/Else Statements")
...
#### Removing Whitespace[​](#removing-whitespace "Direct link to Removing Whitespace")
...
#### Range Blocks[​](#range-blocks "Direct link to Range Blocks")
...
#### Indexing structures in Templates[​](#indexing-structures-in-templates "Direct link to Indexing structures in Templates")
...
#### The `and` Function[​](#the-and-function "Direct link to the-and-function")
...
#### The `or` Function[​](#the-or-function "Direct link to the-or-function")
...
#### The `not` Function[​](#the-not-function "Direct link to the-not-function")
...
## Template Comparison Functions[​](#template-comparison-functions "Direct link to Template Comparison Functions")
...
## Nested Templates and Layouts[​](#nested-templates-and-layouts "Direct link to Nested Templates and Layouts")

#### Nesting Templates[​](#nesting-templates "Direct link to Nesting Templates")
...
#### Passing Variables between Templates[​](#passing-variables-between-templates "Direct link to Passing Variables between Templates")
...
#### Creating Layouts[​](#creating-layouts "Direct link to Creating Layouts")
...
## Templates Calling Functions[​](#templates-calling-functions "Direct link to Templates Calling Functions")

#### Function Variables (calling struct methods)[​](#function-variables-calling-struct-methods "Direct link to Function Variables (calling struct methods)")
...
#### Function Variables (call)[​](#function-variables-call "Direct link to Function Variables (call)")
...
#### Custom Functions (Globally)[​](#custom-functions-globally "Direct link to Custom Functions (Globally)")
